...
import baseline.transformer as transformer
from baseline.mcts import create_node
            ...
            for i in progress(50, "Evaluating... "):
                ...
                while True:
                    ...
                    if obs["current"]["yourIndex"] == your_index:
                        ...
                        selected, _ = mcts_agent(obs, sample_deck, opponent_model)
                    obs_log.append(obs)
