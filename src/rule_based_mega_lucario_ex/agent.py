...
my_deck = [
    ...
    674, 674,              # Hariyama x2
    675, 675,              # Lunatone x2
    676, 676, 676,         # Solrock x3
    677, 677, 677,         # Riolu x3
    678, 678, 678, 678,    # Mega Lucario EX x4
    
    # Items & Tools
    1102, 1102, 1102, 1102,# Dusk Ball x4
    1123, 1123,            # Switch x2
    1141, 1141, 1141, 1141,# Premium Power Pro x4
    1142, 1142, 1142, 1142,# Fighting Gong x4
    1152, 1152, 1152, 1152,# Poké Pad x4
    1159,                  # Hero's Cape x1
    
    # Supporters & Stadiums
    1182, 1182,            # Boss's Orders x2
    1192, 1192, 1192, 1192,# Carmine x4
    1227, 1227, 1227, 1227,# Lillie's Determination x4
    1252, 1252,            # Gravity Mountain x2
    
    # Energy
    6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6 # Basic Fighting Energy x13
]
